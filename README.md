...
<img src="src/images/src/hello.jpg" style="width=200px" alt="hello img"> навігацією та футером, а консоль браузера показує повідомлення Custom JavaScript loaded, збірка працює коректно.    
