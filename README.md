...
4. Відкрийте http://localhost:3000 у браузері. Якщо відображається сторінка з текстом <h1>Hello, coder!</h1>, навігацією та футером, а консоль браузера показує повідомлення Custom JavaScript loaded, збірка працює коректно.    
